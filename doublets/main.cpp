...
int main()
{
  ...
  valid = valid_step("GET", "WEB");
  cout << "From 'GET' to 'WEB' is " << (valid ? "" : "NOT ") << "a valid step." << endl << endl;
  ...
  success = find_chain("AS", "TT", answer, 2);
  cout << (success ? "Found" : "Could not find") << " a chain from 'AS' to 'AT' with up to 4 steps"<< endl;
